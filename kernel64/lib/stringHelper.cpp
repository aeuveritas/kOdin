...
int kStringHelper::kVSPrintf(char* pcBuffer, const char* pcFormatString, va_list ap)
{
    ...
    qwFormatLength = kStrLen(pcFormatString);
    for ( ; qwInputIndex < qwFormatLength; qwInputIndex++)
    {
        ...
        if (pcFormatString[qwInputIndex] == '%')
        {
            ...
            case 's':
                ...
                g_pclMemoryHelper->kMemCpy(pcBuffer + qwOutputIndex, 
